...
// import 'package:lacsapp/core/network/remote/api_constants.dart';
//
...
//           error.response?.headers["content-type"]?.contains("application/json") == true) {
//         // Parse JSON response only if the content-type is application/json
